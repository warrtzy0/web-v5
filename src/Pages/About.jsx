        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              Seorang self-taught developer berumur 17 tahun yang passionate di bidang Front-End. Memanfaatkan AI sebagai tools profesional untuk menciptakan solusi digital yang inovatif.
            </p>
